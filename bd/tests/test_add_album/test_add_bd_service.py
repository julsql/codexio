...
class TestAddBDService(unittest.TestCase):
    NB_COLUMN = 21
    ...
    def setUpClass(cls) -> None:
        ...
        cls.bd_repository = AddAlbumInMemory("AddAlbumBdRepository", ASTERIX)
        cls.service = AddBdService([cls.bd_repository], cls.sheet_repository, cls.logging_repository)

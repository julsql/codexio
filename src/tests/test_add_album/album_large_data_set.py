...
ASTERIX_DATA = {
    'BDPHILE': Album(isbn=9782864976165,
                     ...
                     edition="Édition originale - 1 réédition Noté : Impression en décembre 2022 - n° 616-5-01 Impression et reliure par Pollina - n°13651",
...
THORGAL_DATA = {
    'BDPHILE': Album(
        ...
        edition='Édition originale - 20 rééditions Les 2 premiers tomes sont parus en même temps. Tome 3 à paraître au 4e plat',
